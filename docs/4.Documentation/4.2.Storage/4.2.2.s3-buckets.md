...
![S3-Buckets](img/s3-dashboard-1.png)
...
![S3-Buckets](img/s3-create-1.png) 
...
| :---------- | :----------------------------------- |
|![S3-Buckets](img/s3-create-2.png)  | Only team members can access |
|![S3-Buckets](img/s3-create-3.png)  | Anyone with the URL can read  |
...
![S3-Buckets](img/s3-create-4.png)
...
![S3-Buckets](img/s3-create-5.png)

![S3-Buckets](img/s3-create-6.png)
...
![S3-Buckets](img/s3-browser-1.png)
...
![S3-Buckets](img/s3-browser-2.1.1.1.png)

![S3-Buckets](img/s3-create-4.png)

The **task bars** of the Browser tab allows you to create and manage your objects:

![S3-Buckets](img/s3-browser-2.1.png)

|    Icon   | Function                          |    Icon   | Function                          |    Icon   | Function                          |
| :---------- | :----------------------------------- | :---------- | :----------------------------------- | :---------- | :----------------------------------- |
|![S3-Buckets](img/s3-browse-icon-1.png)  | New Folder |![S3-Buckets](img/s3-browse-icon-5.png)  | Upload |![S3-Buckets](img/s3-browse-icon-9.png)  | Filter |
|![S3-Buckets](img/s3-browse-icon-2.png)  | New File |![S3-Buckets](img/s3-browse-icon-6.png)  | Archive |![S3-Buckets](img/s3-browse-icon-10.png)  | Toggle full screen |
|![S3-Buckets](img/s3-browse-icon-3.png)  | Rename |![S3-Buckets](img/s3-browse-icon-7.png)  | Unarchive |![S3-Buckets](img/s3-browse-icon-11.png)  | Change view |
|![S3-Buckets](img/s3-browse-icon-4.png)  | Delete |![S3-Buckets](img/s3-browse-icon-8.png)  | Search Files |
...
![S3-Buckets](img/s3-shortcuts-1.png)

![S3-Buckets](img/s3-shortcuts-2.png)
...
![S3-Buckets](img/s3-browser-4.png)

![S3-Buckets](img/s3-browser-5.png)
...
![S3-Buckets](img/s3-browser-6.1.png)

![S3-Buckets](img/s3-browser-6.png)
...
![S3-Buckets](img/s3-browser-9.1.png)

![S3-Buckets](img/s3-browser-9.png)

You will need to select the **Unarchive** button to confirm:

![S3-Buckets](img/s3-browser-10.png)
...
![S3-Buckets](img/s3-browser-24.png)

You can select another bucket to copy files between buckets:

![S3-Buckets](img/s3-browser-23.png)
